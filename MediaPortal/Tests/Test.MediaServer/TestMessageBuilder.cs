...
namespace Test.MediaServer
{
    ...
    {
        public TestMediaLibraryAlbumItem(MediaItem item, EndPointSettings settings) : base(item.MediaItemId.ToString(), null, settings) {}
    }
    ...
    class TestMessageBuilder
    {
        ...
        public void TestAudioItem()
        {
          ...
          MediaItem audio = new MediaItem(id, aspects);

          BasicContainer parent = new BasicContainer("0", settings);

          objects.Add(MediaLibraryHelper.InstansiateMediaLibraryObject(audio, null, parent));
        ...
        public void TestAlbumItem()
        {
          ...
          MediaItem album = new MediaItem(id, aspects);
