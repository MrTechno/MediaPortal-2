  ...
  public class MediaLibraryResource : IDirectoryResource
  {
    ...
    public void Initialise()
    {
      ...
      if (dlnaItem.IsImage == false)
      {
        ...
        if (dlnaItem.DlnaMetadata.Audio.Count > 0 && dlnaItem.DlnaMetadata.Audio[0].Frequency > 0)
          SampleFrequency = Convert.ToUInt32(dlnaItem.DlnaMetadata.Audio[0].Frequency);
        if (dlnaItem.DlnaMetadata.Audio.Count > 0 && dlnaItem.DlnaMetadata.Audio[0].Channels > 0)
