      ...
      if (!_hasCompleted)
      {
        ...
        if (directoryPropertyObject is MediaLibraryVideoItem)
        {
          try
          {
            ...
            {
              oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImporterAspect.ATTR_DATEADDED);
            }
            ...
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, VideoStreamAspect.ATTR_WIDTH);
            if (oValue != null)
            {
              dcm += ",WIDTH=" + Convert.ToString(oValue);
            }
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, VideoStreamAspect.ATTR_HEIGHT);
            if (oValue != null)
            {
              dcm += ",HEIGHT=" + Convert.ToString(oValue);
            }
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, MediaAspect.ATTR_RECORDINGTIME);
            if (oValue != null)
            {
        ...
        else if (directoryPropertyObject is MediaLibraryImageItem)
        {
          try
          {
            ...
            object oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_MAKE);
            if (oValue != null)
            {
            ...
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_MODEL);
            if (oValue != null)
            {
            ...
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_FNUMBER);
            if (oValue != null)
            {
            ...
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_ISO_SPEED);
            if (oValue != null)
            {
            ...
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_EXPOSURE_TIME);
            if (oValue != null)
            {
            ...
            string dcm = "CREATIONDATE=" + lCreationDate;
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_WIDTH);
            if (oValue != null)
            {
              dcm += ",WIDTH=" + Convert.ToString(oValue);
            }
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_HEIGHT);
            if (oValue != null)
            {
              dcm += ",HEIGHT=" + Convert.ToString(oValue);
            }
            oValue = MediaServerUtils.GetAttributeValue(res.Item.Aspects, ImageAspect.ATTR_ORIENTATION);
            if (oValue != null)
            {
